          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="size-6 flex-shrink-0 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                >
                  -5 h-5
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">E-books</span>
              </a>
            </li>
            <li>
              <a
